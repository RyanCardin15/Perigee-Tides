...
const transport = new StdioClientTransport({
  ...
  // StdioClientTransport only forwards a minimal env by default; inherit the
  // full environment so proxy/CA settings (HTTPS_PROXY, NODE_EXTRA_CA_CERTS)
  // reach the spawned server in sandboxed/CI environments.
...
// Planner (predictions + local astronomy)
await call("noaa_get_activity_windows", {
  station: "9414290",
  activity: "fishing",
...
await call("noaa_get_king_tides", {
  station: "9414290",
  begin_date: "2026-07-01",
  days: 365,
  timezone: "America/Los_Angeles",
});
await call("noaa_get_tide_calendar", {
  station: "8454000",
  begin_date: "2026-07-10",
  days: 3,
